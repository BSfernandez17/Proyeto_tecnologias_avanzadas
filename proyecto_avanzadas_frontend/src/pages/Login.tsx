...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Después de login, el rol se actualiza automáticamente en el contexto
      // La navegación se maneja en App.tsx basado en el rol
      navigate("/home"); // Intentar navegar a /home, si no es ADMIN, App.tsx redirigirá
    } catch (err: unknown) {
